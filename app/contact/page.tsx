        ...
        <div className="text-center mb-12 md:mb-20">
          ...
          <p className="text-charcoal/60 font-semibold max-w-2xl mx-auto text-xs sm:text-sm md:text-base leading-relaxed">
            {isBurger
              ...
              : 'Got a custom order in mind, need a last-minute delivery, or just want to say hi? Reach out to our team directly or visit our bakery.'}
          </p>
        </div>
            ...
            <div className="bg-cream-light rounded-3xl p-6 sm:p-8 shadow-sm hover:shadow-xl border border-accent-gold/20 transition-all duration-300 relative group overflow-hidden">
              ...
              <div className="flex items-center gap-4 md:gap-6">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  >
                    {isBurger ? 'Head Chef & Grills' : 'Head Baker & Orders'}
                  </p>
                </div>
              </div>
              <div className="mt-6 flex flex-col sm:flex-row gap-3">
                ...
                >
                  <i className="fas fa-phone-alt text-brand-plum"></i> Call Direct
                </button>
                <button 
          ...
          <div className="bg-cream-light rounded-3xl overflow-hidden shadow-sm hover:shadow-xl border border-accent-gold/20 flex flex-col h-full transition-all duration-300">
            <div className="p-6 md:p-8 flex flex-col flex-1">
              ...
              <div className="flex items-start gap-4 mb-6">
                <div 
                  ...
                  style={{ backgroundColor: `${isBurger ? '#E63946' : '#7A1A40'}0A`, color: BRAND_PRIMARY, borderColor: `${BRAND_SECONDARY}50` }}
                >
                  <i className={`fas ${isBurger ? 'fa-store' : 'fa-map-marker-alt'}`}></i>
                </div>
                <div>
                  <h3 className="font-black text-lg text-charcoal mb-1 font-serif-heading">
                    {isBurger ? 'The Burger Bro Kitchen' : 'The Baker Bro Kitchen'}
                  </h3>
                  <p className="text-charcoal/60 text-xs sm:text-sm font-semibold leading-relaxed">
                    {isBurger ? 'Come smell the fresh grills. Jalandhar, Punjab, India.' : 'Come smell the fresh bakes. Jalandhar, Punjab, India.'}
                  </p>
                </div>
              </div>
            ...
            <div className="p-5 md:p-6 bg-cream-bg border-t border-accent-gold/20">
              <a 
                ...
                className="w-full py-4 text-white font-extrabold rounded-xl flex items-center justify-center gap-3 transition-all shadow-md shimmer-btn cursor-pointer active:scale-95 text-xs uppercase tracking-widest"
              >
