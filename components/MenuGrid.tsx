...
export default function MenuGrid({ filteredMenu, isLoading, whatsappNumber }: MenuGridProps) {
  ...
  return (
    <section className="relative z-10 w-full px-4 sm:px-6 lg:px-12 xl:px-20 pb-20 md:pb-28">
      ...
      <div id="menu-heading" className="flex flex-col items-center justify-center gap-2 mb-10 md:mb-16 px-1 text-center scroll-mt-24">
        ...
        >
          {isBurger ? 'Sizzling from the Grill' : 'Fresh From Our Oven'}
        </span>
        
        <div className="flex items-center gap-3 sm:gap-4 justify-center">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-charcoal tracking-tight font-serif-heading">{isBurger ? 'Burger Bro Grill' : 'Our Menu'}</h2>
