...
export default function BakerBentoHighlights() {
    ...
    <section className="relative z-10 container mx-auto px-4 sm:px-6 pb-20 md:pb-28">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
        ...
        >
          ...
          >
            <i className="fas fa-truck-fast text-lg md:text-3xl" style={{ color: BRAND_COLOR }}></i>
          </div>
          <div className="flex-1 flex flex-col items-center">
            <h4 className="font-bold text-charcoal mb-2 text-base md:text-xl leading-tight font-serif-heading">Fast Delivery</h4>
        ...
        >
          ...
          <div className="flex-1 flex flex-col items-center">
            <h4 className="font-bold text-charcoal mb-2 text-base md:text-xl leading-tight font-serif-heading">100% Eggless</h4>
            <p className="text-[11px] sm:text-xs md:text-sm text-charcoal/60 font-semibold leading-relaxed line-clamp-3 md:line-clamp-none">
        ...
        {/* Card 3 - Premium Quality (Gradient Highlight) */}
        <div 
        ...
        >
          ...
          <div className="w-14 h-14 md:w-20 md:h-20 flex-shrink-0 flex items-center justify-center mr-4 md:mr-0 relative z-10 md:mb-6 group-hover:scale-110 transition-transform duration-300 rounded-full bg-white/10">
            <i className="fas fa-certificate text-2xl md:text-4xl text-accent-gold"></i>
          </div>
          
          <div className="flex-1 text-left md:text-center relative z-10">
            <h4 className="text-base sm:text-lg md:text-xl font-bold mb-1.5 md:mb-3 leading-tight font-serif-heading text-accent-gold">Premium Quality</h4>
