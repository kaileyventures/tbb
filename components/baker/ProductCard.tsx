...
export default function BakerProductCard({ item, whatsappNumber }: { item: MenuItem, whatsappNumber: string }) {
      ...
      >
        ...
        <div className="relative aspect-[4/3] w-auto overflow-hidden m-3 rounded-2xl">
          ...
          <span 
            ...
            title="100% Eggless Pure Vegetarian"
          >
