...
export default function BakerContactView() {
  const BRAND_PRIMARY = '#7A1A40'; // Baker Plum
          ...
          <div className="bg-cream-light rounded-3xl overflow-hidden shadow-sm hover:shadow-xl border border-accent-gold/20 flex flex-col h-full transition-all duration-300">
            ...
            <div className="p-5 md:p-6 bg-cream-bg border-t border-accent-gold/20">
              <a 
                ...
                className="w-full py-4 text-white font-extrabold rounded-xl flex items-center justify-center gap-3 transition-all shadow-md bg-brand-plum hover:shadow-lg active:scale-95 text-xs uppercase tracking-widest"
              >
